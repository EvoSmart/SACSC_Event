...
<html>
    <head>
        ...
        <title>SACSC Event Management</title>
        ...
        <link rel="stylesheet"  href="<?php echo $this->url_css; ?>Sc8_Valencia/Sc8_Valencia_menuMobile.css" />
        <link rel="stylesheet"  href="<?php echo $this->url_css; ?>Sc8_Valencia/Sc8_Valencia_menuMobile<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" />
...
<table width="100%" height="67px" class="scMenuHHeader">
        <tr>
                <td width="5px"></td>
        <td width="67px" class="scMenuHHeaderFont">   <IMG SRC="<?php echo $path_imag_cab ?>/grp__NM__img__NM__rsz_logo-white.png" BORDER="0"/></td>
               <td class="scMenuHHeaderFont"><span id="lin1_col1"></span><br /><span id="lin2_col1"></span></td>
               <td align="right" class="scMenuHHeaderFont"><span  id="lin1_col2"></span><br /><span id="lin2_col2"><?php echo "SACSC Event Management" ?></span></td>
        <td width="5px"></td>
    </tr>
</table>
