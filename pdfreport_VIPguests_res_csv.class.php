...
class pdfreport_VIPguests_res_csv
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   //---- 
   function pdfreport_VIPguests_csv()
   {
   ...
   function inicializa_vars()
   {
      ...
      $this->arquivo      .= ".csv";
      $this->tit_doc    = "pdfreport_VIPguests.csv";
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_VIPguests']['csv_name']))
      {
          $this->arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_VIPguests']['csv_name'];
          $this->tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_VIPguests']['csv_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_VIPguests']['csv_name']);
      }
      $this->Res           = new pdfreport_VIPguests_resumo("out");
   ...
   function grava_arquivo()
   {
      ...
      $this->array_titulos = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_VIPguests']['arr_export']['label'];
      $this->array_linhas  = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_VIPguests']['arr_export']['data'];
      $this->comp_y_axys  = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_VIPguests']['pivot_y_axys'];
      $this->comp_tabular = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_VIPguests']['pivot_tabular'];
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_VIPguests']['csv_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_VIPguests']['csv_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->arquivo;
      }
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_chart_titl'] ?> - VIPguests :: CSV</TITLE>
